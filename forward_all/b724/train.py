...
class PINN:
    ...
    def __init__(self):
        ...
        # 边界处的u值
        u_ic = torch.tensor([[0.0005799240889098616,-0.47617821252581694,0.0001896668406230236,-0.47684318777008794]])  # t=0边界处采用第一类边界条件u=-sin(pi*x)
        ...
        # 设置adam优化器
        self.adam = torch.optim.Adam(self.model.parameters(),lr=0.003)#3e-3
